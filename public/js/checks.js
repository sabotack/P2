...
function checkRequiredTransportTo() {
    if (form.eventStartDate.value != '' && form.eventStartTime.value != '' && form.eventLocation.value != '' && eventLocationPicked) {
...
function checkRequiredTransportFrom() {
    if (form.eventEndDate.value != '' && form.eventEndTime.value != '' && form.eventLocation.value != '' && eventLocationPicked)  {
