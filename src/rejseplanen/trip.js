...
async function tripAPICall(parsedData){
    ...
    '&originCoordX='+parsedData.originCoordX+
    '&originCoordY='+parsedData.originCoordY+
    '&destCoordX='+parsedData.destCoordX+
    '&destCoordY='+parsedData.destCoordY+
    '&destCoordName='+parsedData.destCoordName+
